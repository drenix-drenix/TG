...
async def start1(update: types.ChatJoinRequest):
    ...
    await bot.send_message(chat_id=update.from_user.id, text=f"🎁 {update.from_user.get_mention(as_html=True)}<b>, тебе выпал шанс получить 1000₽, пиши /start</b>", parse_mode='html')
